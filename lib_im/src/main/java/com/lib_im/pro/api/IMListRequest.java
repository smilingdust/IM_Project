...
public class IMListRequest extends IMRequestManager {
     ...
     * 查询群组历史纪录
     */
    public Observable<List<GroupChatRecord>> queryGroupChatRecord(String groupId, String logId, String messageId,int page,int rows) {
     ...
     * 查询单人聊天历史纪录
     */
    public Observable<List<ChatRecord>> queryChatRecord(String messageId, String fromUserId, String toUserId, int page,int rows) {
