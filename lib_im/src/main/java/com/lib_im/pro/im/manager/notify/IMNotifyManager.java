...
public class IMNotifyManager implements NotifyManager {
     ...
     */
    @Override
    public void playChatMessage(boolean isRoom, String chatUserId, String chatUserName, String chatRoomJid) {
        ...
        PendingIntent sender = PendingIntent.getActivity(mContext, 0, in, PendingIntent.FLAG_CANCEL_CURRENT);
        android.support.v4.app.NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext)
                ...
                .setContentText(chatUserName + ":" + mContext.getString(R.string.chat_core_send_new_msg))
