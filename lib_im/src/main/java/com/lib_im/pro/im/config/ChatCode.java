...
public class ChatCode {
    ...
    public static final String KEY_USER_ID = "key_user_id";//用户登录id
    public static final String KEY_USER_NAME = "key_user_name";//用户昵称
    public static final String KEY_USER_NICK_NAME = "key_user_nick_name";//用户昵称
    public static final String KEY_USER_PASS = "key_user_pass";//用户密码
    public static final int ERROR_DISCONNECT_OTHER = 110;//未知原因断开
    public static final int ERROR_DISCONNECT_CONFLICT = 111;//用户登录冲突

    public static  String XMPP_SERVER = "192.168.3.150";//openfire服务器ip
    public static  int XMPP_PORT = 5222;//openfire服务器端口
    public static  String XMPP_SERVER_NAME = "127.0.0.1";//openfire服务器名称
    public static final String XMPP_IDENTITY_NAME = "PHONE";// 客户端名称
    public static final int PACKET_TIMEOUT = 10000;// 超时时间
    /**
     * 退出应用全局广播
     */
    ...
    public static final int CHOOSE_PIC = 2;//选择照片
     /**
